    ...
    <div className="max-w-[70vw] home flex flex-col border-1 border-zinc-800 rounded-xl">
      ...
      <div className="py-5 px-3 bg-white">
          ...
          <div className="flex gap-4 px-8 text-zinc-900">
            <Progress value={85} color="secondary" classNames={{indicator: "bg-[#48205D]"}} label="Anglais"/>
            <Progress value={65} color="secondary" classNames={{indicator: "bg-[#48205D]"}} label="Francais"/>
          </div>
